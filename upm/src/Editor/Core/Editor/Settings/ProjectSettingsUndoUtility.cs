...
namespace NoodleHammer.Core.Editor
{
	...
	/// </summary>
	public static class ProjectSettingsUndoUtility
	{
		...
		/// <summary>
		/// Creates a SerializedObject for the given storage and begins tracking it for undo/redo persistence.
		/// </summary>
		public static SerializedObject CreateSerializedObject(ScriptableObject storage, Action persistAndNotify)
		{
		...
		/// <summary>
		/// Applies modified properties and persists if changes were made.
		/// </summary>
		public static void ApplyModifiedProperties(SerializedObject serializedObject)
		{
		...
		/// <summary>
		/// Resets the storage to defaults with full undo support.
		/// </summary>
		public static void ResetToDefaultsWithUndo(
